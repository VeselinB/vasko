...
<div id="releases">
    ...
    -->
    <div class="release">
        <h1>Release Notes for Sencha Cmd 7.5.0</h1>
        <div class="notes">
            Date: October 7, 2021<br>
            Version Number: 7.5.0.5<br>
            <div class="platforms">
                ...
                <div class="installers win win32 win64">
                    <a class="jre64" href="../7.5.0.5/jre/SenchaCmd-7.5.0.5-windows-64bit.zip">64-bit</a>
                    <a class="jre32" href="../7.5.0.5/jre/SenchaCmd-7.5.0.5-windows-32bit.zip">32-bit</a><span class="alt">
                    <a class="nojre" href="../7.5.0.5/no-jre/SenchaCmd-7.5.0.5-windows-no_jre.zip">no_jre</a>
                    <a class="zip" href="../7.5.0.5/zip/SenchaCmd-7.5.0.5-windows.zip">zip</a></span>
                </div>
                <br/>
                <div class="disable-selection expandable collapsed platform mac" onclick="toggleAlt(this)">Mac OS X:
                    ...
                    <a class="jre" href="../7.5.0.5/jre/SenchaCmd-7.5.0.5-osx.app.zip">app</a><span class="alt">
                    <a class="nojre" href="../7.5.0.5/no-jre/SenchaCmd-7.5.0.5-osx-no_jre.app.zip">no_jre</a>
                    <a class="zip" href="../7.5.0.5/zip/SenchaCmd-7.5.0.5-osx.zip">zip</a></span>
                </div>
                <br />
                <div class="disable-selection platform linux">
                    ...
                    <div class="installers linux32">
                        <a class="sh" href="../7.5.0.5/no-jre/SenchaCmd-7.5.0.5-linux-i386.sh.zip">sh</a><span class="alt">
                        <a class="deb" href="../7.5.0.5/no-jre/SenchaCmd-7.5.0.5-linux-i386.deb">deb</a>
                        <a class="rpm" href="../7.5.0.5/no-jre/SenchaCmd-7.5.0.5-linux-i386.rpm">rpm</a>
                        <a class="zip" href="../7.5.0.5/zip/SenchaCmd-7.5.0.5-linux-i386.zip">zip</a></span>
                    </div>
                    <br/>
                    ...
                    <div class="installers linux64">
                        <a class="sh" href="../7.5.0.5/no-jre/SenchaCmd-7.5.0.5-linux-amd64.sh.zip">sh</a><span class="alt">
                        <a class="deb" href="../7.5.0.5/no-jre/SenchaCmd-7.5.0.5-linux-amd64.deb">deb</a>
                        <a class="rpm" href="../7.5.0.5/no-jre/SenchaCmd-7.5.0.5-linux-amd64.rpm">rpm</a>
                        <a class="zip" href="../7.5.0.5/zip/SenchaCmd-7.5.0.5-linux-amd64.zip">zip</a></span>
                    </div>
                </div>
                <br/>
                <div class="options">
